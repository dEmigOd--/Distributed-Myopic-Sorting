classdef StateMachine < Cylinders.StateMachine.GenericStateMachine
    ...
    %
    % zero conceptual bit of time parity (to prevent possible collisions in next pair NW vs SE) and one of direction up/down
    % 1 is the bit value to move north in 5,9; 0 - to move south and west
    % This is a dual problem! the agent will patrol the grid
    % it is a mirrored ver of 102 algorithm
    
    properties (Constant)
        MasksVersion = 20200609;
        TimerBits = 0;
        ValueBits = 1;
    end
