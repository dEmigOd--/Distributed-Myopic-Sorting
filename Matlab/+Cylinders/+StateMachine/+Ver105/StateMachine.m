classdef StateMachine < Cylinders.StateMachine.GenericStateMachine
    %STATEMACHINE Actual Implementation of (Motor) ZigZag algorithm
    % works on AT LEAST TWO ROWS and TWO COLUMNS !
    %
    % two value bits : 1 is used to zig zag traverse rows
    % then third value is used to "carriage return"
    ...
    methods (Access = protected)
        function [] = InitStateMachines(this)
            ...
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                    {empty, { ... 
                                Cylinders.StateMachine.Action(zigzag_west, go_north), ...
                                Cylinders.StateMachine.Action(zigzag_west, do_nothing), ...
                                Cylinders.StateMachine.Action(zigzag_west, go_west), ...
                            }}, ...
                } ...                
            );            
            ...
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                        {empty,         ...
                                    {   ...
                                        Cylinders.StateMachine.Action(zigzag_east, go_north), ...
                                        Cylinders.StateMachine.Action(zigzag_east, go_north), ...
                                        Cylinders.StateMachine.Action(zigzag_east, go_east), ...
                                    }}, ...
                } ...                
            );
            ...
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                        {empty,         ...
                                    {   ...
                                        Cylinders.StateMachine.Action(zigzag_east, go_east), ...
                                        Cylinders.StateMachine.Action(carriage_return, go_south), ...
                                    }}, ...
                } ...                
            );
