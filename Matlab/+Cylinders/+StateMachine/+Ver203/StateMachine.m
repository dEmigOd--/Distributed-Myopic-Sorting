classdef StateMachine < Cylinders.StateMachine.TimerStateMachine
    ...
    % This is a primal algorithm! Produces a path similar to the dual algorithm of Algorithm-102
    % But which does not hit the first row, when parsing the columns
    
    properties (Constant)
        MasksVersion = 20200614;
        TimerBits = 1;
        ValueBits = 1;
    end
    ...
    methods (Access = protected)
        function [] = InitStateMachines(this)
            ...
            %% here comes position 7 [south, east]
            currentPosition = 7;
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                        {[agent, empty]         ...
