classdef StateMachine < Cylinders.StateMachine.TimerStateMachine
    ...
    % VER 1 is the base line
    % SPEEDUP is implemented where possible (i.e. not waiting for right turn in positions 1, 5, 9
            ...
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                    {[empty, empty], { ... % check out that 2 is impossible memory state at poisiton 5
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ...
                                     }}, ...
                    {[agent, empty], { ... 
            ...
            this.stateMachine{currentPosition} = this.CreateStateMachine(masks, currentPosition, ...
                { ...
                    ...
                    {[empty, empty, empty, empty], { ... 
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_north), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_north), ...
                                     }}, ...
                    {[empty, empty, agent, empty],	...
                                     { ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ... 
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_west), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, do_nothing), ...
                                        Cylinders.StateMachine.Action(north_9_north_5_direction, go_north), ...
                                     }}, ...
