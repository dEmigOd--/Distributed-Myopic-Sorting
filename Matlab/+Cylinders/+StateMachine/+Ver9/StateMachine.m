classdef StateMachine < Cylinders.StateMachine.TimerStateMachine
    ...
    % another fix is to adjust position 1 [first column] to the position 5 [second column] !!
    % This should fix this weird two-time FIRST only passage of the m-1 column
