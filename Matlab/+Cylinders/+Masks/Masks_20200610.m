classdef Masks_20200610 < Cylinders.Masks.MasksSensed_1
    %MASKS_20200610 those are masks for DUAL (202) agents at different states, but with visibility = 1
    ...
    methods
        function obj = Masks_20200610()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20200610.RequiredVisibility());
        end
