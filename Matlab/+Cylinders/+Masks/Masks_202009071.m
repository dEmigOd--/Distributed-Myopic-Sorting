classdef Masks_202009071 < Cylinders.Masks.MasksSensed_1
    %MASKS_202009071 those are masks for agents at different states, but with visibility = 1
    % For the Sorting algorithm ver = 308
    % This is the EXITING two-column road Sensor Mask
    ...
    methods
        function obj = Masks_202009071()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_202009071.RequiredVisibility());
        end
