classdef Masks_20200830 < Cylinders.Masks.MasksSensed_1
    %MASKS_20200830 those are masks for agents at different states, but with visibility = 1
    % For the Sorting algorithm ver = 301
    % This is an CONTINUING vehicles Sensor Mask
    ...
    methods
        function obj = Masks_20200830()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20200830.RequiredVisibility());
        end
