classdef Masks_20201011 < Cylinders.Masks.MasksSensed_1
    %MASKS_20201011 those are masks for agents at different states, but with visibility = 1
    % For the Sorting algorithm ver = 311
    ...
    methods
        function obj = Masks_20201011()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20201011.RequiredVisibility());
        end
