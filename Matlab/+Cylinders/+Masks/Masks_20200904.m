classdef Masks_20200904 < Cylinders.Masks.MasksSensed_1
    ...
    methods
        function obj = Masks_20200904()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20200904.RequiredVisibility());
        end
