classdef Masks_20210119 < Cylinders.Masks.MasksSensed_1
    %MASKS_20210119 those are masks for agents at different states, but with visibility = 1
    % For the Sorting algorithm ver = 316 (310 with a slight change
    ...
    methods
        function obj = Masks_20210119()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20210119.RequiredVisibility());
        end
