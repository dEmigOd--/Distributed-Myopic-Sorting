classdef Masks_20200614 < Cylinders.Masks.MasksSensed_1
    %MASKS_20200614 those are masks for agents at different states, but with visibility = 1
    ...
    methods
        function obj = Masks_20200614()
            obj = obj@Cylinders.Masks.MasksSensed_1(Cylinders.Masks.Masks_20200614.RequiredVisibility());
        end
