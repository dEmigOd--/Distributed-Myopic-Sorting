...
\begin{document}
	...
	\pgfmathsetmacro{\opacityfactor}{0.4}
	...
	\begin{tikzpicture}
		...
		\newcommand{\neighborsCoordinates}{1/0, 0/-1, 0/1, -1/0}
		\newcommand{\neighbors}{}
		...
		\begin{scope}[scale=\cellsize]
			...
			\SetTableValues{0}{4}{0}{1}
			\SetTableValues{1}{4}{0}{1}
			\SetTableValues{2}{4}{0}{4}
			\SetTableValues{3}{4}{0}{4}
			\SetTableValues{0}{5}{5}{4}
			\SetTableValues{1}{5}{1}{1}
			...
			\SetTableValues{0}{7}{3}{2}
			\SetTableValues{1}{7}{7}{4}
			\SetTableValues{2}{7}{3}{2}
