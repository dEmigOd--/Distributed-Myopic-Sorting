...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\newcommand{\neighborsCoordinates}{-1/1, -1/0, 0/2, 0/1, 0/-1, 1/0, 1/1, 2/0, 1/-1, 0/-2, -1/-1, -2/0}
		\newcommand{\neighbors}{}
		...
		\begin{scope}[scale=\cellsize]
			...
			\SetTableValues{8}{1}{1}{4}
			\SetTableValues{9}{1}{1}{4}
			\SetTableValues{10}{1}{1}{4}
			\SetTableValues{11}{1}{1}{4}
			\SetTableValues{12}{1}{3}{4}
			\SetTableValues{13}{1}{3}{4}
			\SetTableValues{14}{1}{3}{4}
			\SetTableValues{15}{1}{3}{4}
			\SetTableValues{0}{2}{0}{3}
			\SetTableValues{1}{2}{0}{0}
			\SetTableValues{2}{2}{0}{0}
			\SetTableValues{3}{2}{2}{4}
			\SetTableValues{4}{2}{0}{0}
			\SetTableValues{5}{2}{0}{0}
			\SetTableValues{6}{2}{0}{4}
			\SetTableValues{7}{2}{0}{4}
			\SetTableValues{8}{2}{0}{0}
			\SetTableValues{9}{2}{0}{0}
			\SetTableValues{10}{2}{0}{0}
			\SetTableValues{11}{2}{0}{0}
			\SetTableValues{12}{2}{0}{3}
			\SetTableValues{13}{2}{0}{3}
			\SetTableValues{14}{2}{2}{4}
			\SetTableValues{15}{2}{2}{4}
			...
			\SetTableValues{7}{3}{1}{4}
			\SetTableValues{8}{3}{3}{4}
			\SetTableValues{9}{3}{3}{4}
			\SetTableValues{10}{3}{1}{4}
			\SetTableValues{11}{3}{1}{4}
			\SetTableValues{12}{3}{3}{4}
			\SetTableValues{13}{3}{3}{4}
			\SetTableValues{14}{3}{3}{4}
			\SetTableValues{15}{3}{3}{4}
			\SetTableValues{0}{4}{0}{3}
			\SetTableValues{1}{4}{0}{3}
			\SetTableValues{2}{4}{0}{3}
			\SetTableValues{3}{4}{0}{3}
			\SetTableValues{4}{4}{0}{3}
			\SetTableValues{5}{4}{0}{3}
			\SetTableValues{6}{4}{2}{4}
			\SetTableValues{7}{4}{0}{4}
			\SetTableValues{8}{4}{2}{4}
			\SetTableValues{9}{4}{2}{4}
			\SetTableValues{10}{4}{2}{4}
			\SetTableValues{11}{4}{0}{4}
			\SetTableValues{12}{4}{0}{3}
			\SetTableValues{13}{4}{0}{3}
