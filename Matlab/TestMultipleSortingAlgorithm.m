...
n = 16;
m = 2;
k = 3; % number of empty spaces
num_exiting = n - 1;

test_version = 319;%310;%319;
% supported cases
...
%
% 319 - (1, 3) Sorting algorithm. Two Lane algorithm. WORKS. And up to n. 318 + changed D-bit reset timing in pos 6 and 8
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

max_iterations = 30000; % basically forever
stop_on_completion = false; % just do not stop;

filename_animation = 'Grid.Sorting.Ver.310';
frames_per_second_animation = 8;
if(produce_animation)
    progress_recorders = [Recorder.GridRecorder(n, m, filename_animation, 'grid.agents.common.sorting', frames_per_second_animation)];
else
    progress_recorders = [];
end
