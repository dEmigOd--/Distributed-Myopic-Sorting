classdef FSMv1 < Beads.AbstractFSM
    %FSMV1 The visibility = 1 memory-based sorting for two lanes blocks
    ...
    methods
        function obj = FSMv1()
            ...
            obj.memory_map(2, north_indices, [1, 3]) = lock2 + 2;
            obj.memory_map(2, south_indices, [2, 4]) = lock2 + 2;
