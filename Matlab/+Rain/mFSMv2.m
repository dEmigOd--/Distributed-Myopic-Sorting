classdef mFSMv2 < Snake.AbstractFSM
	...
	methods
		function obj = mFSMv2()
			...
			obj.memory_map = Error * ones(2 ^ Rain.mFSMv2.GetBits(), 2 ^ Snake.AbstractFSM.num_readings, 9);
			obj.direction_map = Error * ones(2 ^ Rain.mFSMv2.GetBits(), 2 ^ Snake.AbstractFSM.num_readings, 9);
