classdef mFSMv3 < Snake.AbstractFSM
    %MFSMV3 the multiple empty space coverage automatons
	...
	methods
		function obj = mFSMv3()
			...
			obj.memory_map = mem_Error * ones(2 ^ Rain.mFSMv3.GetBits(), 2 ^ Snake.AbstractFSM.num_readings, 9);
			obj.direction_map = Error * ones(2 ^ Rain.mFSMv3.GetBits(), 2 ^ Snake.AbstractFSM.num_readings, 9);
            ...
            obj.direction_map(1:4, 1:8, 6) = [ ...
                ...
                do_nothing, do_nothing, go_east, do_nothing, do_nothing, do_nothing, go_east, do_nothing];
