classdef FSMv101 < Snake.AbstractFSM
	%FSMV101 The first 1-bit distributed version
	...
	methods
		function obj = FSMv101(~)
			...
			obj.memory_map = Error * ones(2 ^ Snake.FSMv101.GetBits(), 4, 9); % 5 is when no input is given
			obj.direction_map = Error * ones(2 ^ Snake.FSMv101.GetBits(), 4, 9);
