classdef FSMv6 < Snake.AbstractFSM
	%FSMV7 Summary of this class goes here
	...
	methods
		function obj = FSMv6(~)
			...
			obj.memory_map = Error * ones(2 ^ Snake.FSMv6.GetBits(), 4, 9); % 5 is when no input is given
			obj.direction_map = Error * ones(2 ^ Snake.FSMv6.GetBits(), 4, 9);
