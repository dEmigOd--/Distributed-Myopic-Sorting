...
%\addlegendentry{$\text{T}_{\text{est}}\text{ = 10.881}\cdot\text{n}\cdot\text{m}^\text{2}\text{ + O(m)}$}
...
%\addlegendentry{$\text{T}_{\text{ub}}\text{ = 24.000}\cdot\text{n}\cdot\text{m}^\text{2}\text{ + O(m)}$}
