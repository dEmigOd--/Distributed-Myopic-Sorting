...
\addlegendentry{$\text{n =  6; T}_{\text{est}}\text{ = 2.166} \cdot \text{n} \cdot \text{m}^\text{2}\text{ + }O(\text{m})$}
...
\addlegendentry{$\text{n =  8; T}_{\text{est}}\text{ = 2.496} \cdot \text{n} \cdot \text{m}^\text{2}\text{ + }O(\text{m})$}
...
\addlegendentry{$\text{n = 10; T}_{\text{est}}\text{ = 2.673} \cdot \text{n} \cdot \text{m}^\text{2}\text{ + }O(\text{m})$}
...
\addlegendentry{$\text{n = 12; T}_{\text{est}}\text{ = 2.700} \cdot \text{n} \cdot \text{m}^\text{2}\text{ + }O(\text{m})$}
...
\addlegendentry{$\text{n = 14; T}_{\text{est}}\text{ = 2.864} \cdot \text{n} \cdot \text{m}^\text{2}\text{ + }O(\text{m})$}
