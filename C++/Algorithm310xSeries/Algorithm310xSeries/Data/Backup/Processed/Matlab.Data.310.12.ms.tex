...
\addlegendentry{$\text{n =  4; T}_{\text{est}}\text{ =  4.9m + }O\text{(1)}$}
...
\addlegendentry{$\text{n =  8; T}_{\text{est}}\text{ =  8.1m + }O\text{(1)}$}
...
\addlegendentry{$\text{n = 12; T}_{\text{est}}\text{ =  9.7m + }O\text{(1)}$}
...
\addlegendentry{$\text{n = 16; T}_{\text{est}}\text{ = 10.5m + }O\text{(1)}$}
