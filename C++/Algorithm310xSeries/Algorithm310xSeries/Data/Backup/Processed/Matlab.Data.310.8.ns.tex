...
\addlegendentry{$\text{m = 3; T}_{\text{est}}\text{ = 1.159n}^\text{2}\text{ + }O(\text{n})$}
...
\addlegendentry{$\text{m = 4; T}_{\text{est}}\text{ = 2.616n}^\text{2}\text{ + }O(\text{n})$}
...
\addlegendentry{$\text{m = 5; T}_{\text{est}}\text{ = 3.920n}^\text{2}\text{ + }O(\text{n})$}
...
\addlegendentry{$\text{m = 6; T}_{\text{est}}\text{ = 6.055n}^\text{2}\text{ + }O(\text{n})$}
...
\addlegendentry{$\text{m = 7; T}_{\text{est}}\text{ = 7.267n}^\text{2}\text{ + }O(\text{n})$}
