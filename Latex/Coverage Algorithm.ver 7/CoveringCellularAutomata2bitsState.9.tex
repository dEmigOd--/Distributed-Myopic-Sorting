...
\begin{document}
	...
	\begin{tikzpicture}
		...
		% hatch single cells
		\foreach \x/\y in {0/0, 1/1, 2/0, 3/0, 3/1, 3/2, 3/3}
		{
		...
		\node (n_0N) at (0N) {0, N};
		\node (n_1N) at (1N) {2, $\emptyset$};
		\node (n_2N) at (2N) {3, N};
		\node (n_3N) at (3N) {3, $\emptyset$};
		\node (n_0E) at (0E) {2, $\emptyset$};
		\node (n_1E) at (1E) {2, $\emptyset$};
		\node (n_2E) at (2E) {2, $\emptyset$};
		\node (n_3E) at (3E) {2, $\emptyset$};
		\node (n_0S) at (0S) {2, $\emptyset$};
		\node (n_1S) at (1S) {2, $\emptyset$};
		\node (n_2S) at (2S) {3, S};
		\node (n_3S) at (3S) {3, $\emptyset$};
		\node (n_0W) at (0W) {0, $\emptyset$};
		\node (n_1W) at (1W) {1, $\emptyset$};
		\node (n_2W) at (2W) {2, $\emptyset$};
		\node (n_3W) at (3W) {3, $\emptyset$};
