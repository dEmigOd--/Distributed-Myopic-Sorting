...
\begin{document}
	\begin{tikzpicture}
		...
		% set cell values
		\node (node_00) at (0 + \valuexoffset, 1 + \valueyoffset) {1, $\emptyset$};
		...
		\node (node_11) at (1 + \valuexoffset, 0 + \valueyoffset) {0, $\emptyset$};
		\node (node_21) at (2 + \valuexoffset, 0 + \valueyoffset) {1, $\emptyset$};
		\node (node_31) at (3 + \valuexoffset, 0 + \valueyoffset) {0, $\emptyset$};
		
		% hatch error cells
		\foreach \x/\y in {1/1, 3/1, 2/0}
		{
