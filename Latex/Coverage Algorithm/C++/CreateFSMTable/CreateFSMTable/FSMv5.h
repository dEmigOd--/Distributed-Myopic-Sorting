	...
	static StateFSM<2>* _GetState(int index)
	{
		...
		if (!initialized)
		{
			...
			states[7] = StateFSM<2>({ { ZeroBit, {OneBit, ErrorBit, TwoBits, ZeroBit }},
				...
				{ ThreeBits, {DoNothing, Error, Error, DoNothing }} },
				{ East } );
			states[8] = StateFSM<2>({ { ZeroBit, {ZeroBit, TwoBits, OneBit, ZeroBit }},
