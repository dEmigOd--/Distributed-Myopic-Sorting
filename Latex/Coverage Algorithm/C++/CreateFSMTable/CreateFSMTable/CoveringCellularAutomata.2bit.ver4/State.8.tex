...
\begin{document}
	\begin{tikzpicture}
		...
		% set cell values
		\node (node_00) at (0 + \valuexoffset, 3 + \valueyoffset) {1, N};
		\node (node_20) at (2 + \valuexoffset, 3 + \valueyoffset) {1, $\emptyset$};
		...
		\node (node_02) at (0 + \valuexoffset, 1 + \valueyoffset) {2, $\emptyset$};
